...
def cmd_show(args: argparse.Namespace) -> None:
    ...
    try:
        ...
        if len(recent_draws) < 20:
            ...
            print("\n使用建议：一肖 + 连肖重点投入，五连肖适合长期小注。以量取胜，娱乐为主！")
    finally:
        conn.close()
